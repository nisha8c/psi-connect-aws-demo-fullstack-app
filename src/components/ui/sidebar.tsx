...
/* Inset                                                               */
/* ------------------------------------------------------------------ */
export type SidebarInsetProps = DivProps;
...
export const SidebarHeader = React.forwardRef<HTMLDivElement, DivProps>(
    ({ className, ...props }, ref) => (
...
export const SidebarFooter = React.forwardRef<HTMLDivElement, DivProps>(
    ({ className, ...props }, ref) => (
...
export const SidebarContent = React.forwardRef<HTMLDivElement, DivProps>(
    ({ className, ...props }, ref) => (
        <div
            ref={ref}
...
export const SidebarGroup = React.forwardRef<HTMLDivElement, DivProps>(
    ({ className, ...props }, ref) => (
...
export const SidebarGroupContent = React.forwardRef<HTMLDivElement, DivProps>(
    ({ className, ...props }, ref) => (
...
export const SidebarMenuBadge = React.forwardRef<HTMLDivElement, DivProps>(
    ({ className, ...props }, ref) => (
        <div
            ref={ref}
